  ...
  >
    <div className="prose prose-slate max-w-none text-sm leading-relaxed">
      ...
      <CollapsibleSection title="一、埋点文档" defaultOpen={true}>
        ...
        <a
          href="https://doc.weixin.qq.com/sheet/e3_AUEAhwa7AKcCNkvFjEA9WQrSBTH0y?scode=AG4AJAc6AAguA"
          target="_blank"
          rel="noopener noreferrer"
          className="text-blue-600 hover:underline break-all"
        >
          https://doc.weixin.qq.com/sheet/e3_AUEAhwa7AKcCNkvFjEA9WQrSBTH0y?scode=AG4AJAc6AAguA
        </a>
      ...
      {/* 埋点事件清单 */}
      <CollapsibleSection title="三、埋点事件清单（一期·移动端）">
        <p className="text-slate-700 mb-3">
        ...
        <div className="overflow-x-auto">
          <table className="w-full border-collapse text-sm">
            <thead>
              <tr className="bg-slate-100">
                <th className="border border-slate-300 px-3 py-2 text-left font-semibold text-slate-800">事件名</th>
                <th className="border border-slate-300 px-3 py-2 text-left font-semibold text-slate-800">触发时机</th>
                <th className="border border-slate-300 px-3 py-2 text-left font-semibold text-slate-800">关键参数</th>
                <th className="border border-slate-300 px-3 py-2 text-left font-semibold text-slate-800">去重规则</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td className="border border-slate-300 px-3 py-2 font-mono text-xs text-slate-700">recommendation_exposure</td>
                <td className="border border-slate-300 px-3 py-2 text-slate-700">推荐卡片 ≥50% 面积进入可视区域</td>
                <td className="border border-slate-300 px-3 py-2 text-slate-700">auction_id, buyer_id, device_type, position</td>
                <td className="border border-slate-300 px-3 py-2 text-slate-700">同一会话内同一 buyer + auction 不重复计</td>
              </tr>
              <tr>
                <td className="border border-slate-300 px-3 py-2 font-mono text-xs text-slate-700">bid_action</td>
                <td className="border border-slate-300 px-3 py-2 text-slate-700">用户对推荐车辆发起出价</td>
                <td className="border border-slate-300 px-3 py-2 text-slate-700">auction_id, buyer_id, bid_amount, position</td>
                <td className="border border-slate-300 px-3 py-2 text-slate-700">同一 buyer + auction 多次出价仅计 1 次</td>
              </tr>
            </tbody>
          </table>
        </div>
