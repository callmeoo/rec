    ...
    >
      ...
      {activeInnerTab === '数据基础' && (
        <div className="prose prose-slate max-w-none text-sm leading-relaxed">
          ...
          {/* 买家画像 - 可折叠 */}
          <CollapsibleSection title="买家画像" defaultOpen={true}>
            <p className="text-slate-700 mb-2">
          ...
          {/* 平台周转率 - 可折叠 */}
          <CollapsibleSection title="平台周转率" defaultOpen={true}>
            ...
            <h4 className="text-sm font-semibold text-slate-800 mt-4 mb-2">1、<span className="text-red-600">基础定义（按车系维度，可能每天上拍量不足200台）</span></h4>
            <ul className="list-disc list-inside space-y-1 text-slate-700 mb-3">
            ...
            <h4 className="text-sm font-semibold text-slate-800 mt-4 mb-2">2、统计指标</h4>
            <ul className="list-disc list-inside space-y-1 text-slate-700 mb-3">
            ...
            <h4 className="text-sm font-semibold text-slate-800 mt-4 mb-2">3、综合周转分</h4>
            <p className="text-slate-700 mb-2">
